...
// `autoFocusSurface` (optionnel, ORA-167/179) : focus le champ Surface au
// montage à la place de Quartier — utilisé par le lien "+ Surface" de
// ResultCard (quartier déjà rempli, seule la surface manque).
export default function SearchForm({
  ville, onVilleChange, onScan, isLoading, quartierOptions,
  initialQuartier = '', initialTypeLocal = 'Tout', initialSurface = '',
  autoFocus = true, autoFocusSurface = false,
}) {
        ...
        <div className="relative">
          ...
          <div className="relative">
            ...
            <input
              ...
              autoFocus={autoFocus && !autoFocusSurface}
              type="text"
              value={quartier}
              onChange={(e) => {
