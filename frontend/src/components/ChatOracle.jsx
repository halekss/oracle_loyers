...
export default function ChatOracle({ analysis, context, quartier }) {
  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { sender: "oracle", text: oracleResponse },
      ]);
    } catch (error) {
              ...
              {msg.sender === "oracle" ? (
                ...
                <ReactMarkdown
                  ...
                  components={{
                    ...
                    h3: (props) => (
                      <h3
                        className="text-xs font-black uppercase tracking-widest text-purple-300 mb-2 mt-4 border-b border-slate-600 pb-1"
                        {...props}
                      />
                    ),
                    ul: (props) => (
                    ...
                    li: (props) => (
                      <li className="marker:text-purple-500 pl-1" {...props} />
                    ),
                ...
                >
                  {/* FIX : On s'assure que c'est une string. Si c'est un objet, on prend .response */}
                  {typeof msg.text === "object" ? msg.text.response : msg.text}
                </ReactMarkdown>
              ) : (
